 ...
 */
public class SetElevatorPositionBeforeRetraction extends CommandBase {
  ...
  private static final TunableNumber additionalExtenstion =
   ...
   */
  public SetElevatorPositionBeforeRetraction(
      Elevator subsystem, LoggedDashboardChooser<Position> armChooser) {
    this.elevator = subsystem;
