...
public class SetIntakePosition extends CommandBase {
   ...
   * @return
   */
  public SetIntakePosition(Intake subsystem, double position) {
    intake = subsystem;
  ...
  public void initialize() {
    Logger.getInstance().recordOutput("ActiveCommands/SetIntakePosition", true);
    intake.setRotationPosition(position);
  }
  ...
  public void end(boolean interrupted) {
    Logger.getInstance().recordOutput("ActiveCommands/SetIntakePosition", false);
  }

  /** This method is invoked at the end of each Command Scheduler iteration. */
  @Override
  public boolean isFinished() {
    return intake.isAtRotationSetpoint();
  }
}
